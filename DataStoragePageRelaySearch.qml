...
Item {
        ...
        RowLayout {
            ...
            ToolButton {
                   ...
                   onClicked: {
                       ...
                       if (currentField) {
                           ...
                           var NameSearch = JSON.stringify({"objectName": "SearchName","categories":"Relay","text": nameFile});
            ...
            ToolButton {
                ...
                onClicked: {
                    ...
                    if (currentField) {
                        currentField.text = nameFile;
                        var DataSearch = JSON.stringify({"objectName": "SearchDate","categories":"Relay","text": nameFile});
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            ...
                            var getNameRelay = '{"objectName":"sortnamePattern", "Sort":'+isAscending+' , "categories":"Relay"}';
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            ...
                            var getDateRelay =  '{"objectName":"sortdatePattern", "Sort":'+isAscending+' , "categories":"Relay"}';
                            qmlCommand(getDateRelay);
                            clearDataRelay();
                        }
                    }
                }
                ...
                TableView {
                    ...
                    onClicked: {
                        var selectedFilename = relayDataStorage.get(row).filename;
                        var selectedEventDatetime = relayDataStorage.get(row).event_datetime;

                        console.log("Selected Row:", row,);
                        console.log("Filename:", relayDataStorage.get(row).filename);
                        console.log("Event Date:", relayDataStorage.get(row).event_datetime);
    ...
    function clearDataRelay() {
        relayDataStorage.clear();
