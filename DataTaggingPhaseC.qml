...
Item {
    ...
    RowLayout {
        ...
        Button {
            ...
            onClicked: {
                var rowIndex = getSelectedModelIndexC()
                if (rowIndex !== -1 && newlistdatatebleA.count > rowIndex) {
                    ...
                    console.log("✏️ Editing Row C: dbNo =", selectedRowIndex,
                                "modelIndex =", rowIndex,
        ...
        Button {
            ...
            onClicked: {
                ...
                if (rowIndex !== -1 && distanceField.text.trim() !== "" && detailField.text.trim() !== "") {
                    ...
                    console.log("SAVE Data C:", saveData)
                    qmlCommand(saveData)
                } else {
    ...
    function getSelectedModelIndexC() {
        if (selectedRowIndex === -1)
            return -1
        return getDeviceIndexByPhase(selectedRowIndex, "C")
    }
