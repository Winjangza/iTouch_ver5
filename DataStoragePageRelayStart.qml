    ...
    RowLayout {
        ...
        Rectangle {
                ...
                ToolButton {
                    ...
                    onClicked: {
                        if (selectedFilename !== "" && selectedEventDatetime !== "") {
                            ...
                            datastoragePageRelaySearch.clearTableRequested();
                            console.log(ButtonpatternData);
                            qmlCommand(ButtonpatternData);
                        } else {
                            console.log("No row selected!");
            ...
            TextField {
                ...
                onFocusChanged: {
                    if (focus && !fileNameRelayStart.readOnly ) {
                        fileNameRelayStart.focus = false;
                        currentField = "newFileNameRelayStart";
                        ...
                        fileNameRelayStart.color = "#ff0000";
                    }
                }
            }
        }
        DataStoragePageRelaySearch {
            id: datastoragePageRelaySearch
            Layout.fillWidth: true
            Layout.fillHeight: true
